...
// Just enough of Menu for glue that offers a context menu: items record what
// they were given, specs click them, and the last shown menu is kept for
// inspection.
export class MenuItem {
  title = ''
  icon: string | null = null
  checked: boolean | null = null
  #onClick: ((event: MouseEvent | KeyboardEvent) => unknown) | null = null
...
export class Menu {
  ...
  shownAt: MouseEvent | { x: number; y: number } | null = null
