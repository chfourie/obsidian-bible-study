...
- **Indexing:** each parseable member is an occurrence with source `cross-reference-frontmatter`, position 0. A cross-reference note is never a Mention, whatever its body references.
